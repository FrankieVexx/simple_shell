"manpage for Simple_shell. Simple shell project to ALX - Holberton
.TH man 1 "November 2022" "Simple Shell"                    "14 April 2021" "1.0"                                              "simple_shell man page"
SH NAME
...
.LP
.B hsh
is an sh-compatible command language interpreter that reads and executes commands from standard input. It is conformed to the POSIX specificati>
.LP
...
.SH AUTHORS
written by Francis Omiti & Francis Onyach
